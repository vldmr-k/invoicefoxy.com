...
class CompanyAddressStep extends StatefulWidget {
  const CompanyAddressStep({super.key});

  @override
  createState() => _CompanyAddressStepState();
}

class _CompanyAddressStepState extends JourneyState<CompanyAddressStep> {
  _CompanyAddressStepState() : super(
  ...
  Widget view(BuildContext context) {
    return buildJourneyContent(
      content: Column(
        ...
        children: [
          Text('CompanyNameStep', style: Theme.of(context).textTheme.headlineMedium),
