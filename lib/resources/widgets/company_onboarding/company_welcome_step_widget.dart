...
class CompanyWelcomeStep extends StatefulWidget {
  const CompanyWelcomeStep({super.key});

  @override
  createState() => _CompanyWelcomeStepState();
}

class _CompanyWelcomeStepState extends JourneyState<CompanyWelcomeStep> {
  _CompanyWelcomeStepState() : super(
  ...
  Widget view(BuildContext context) {
    return buildJourneyContent(
      content: Column(
        ...
        children: [
          Text('CompanyWelcome', style: Theme.of(context).textTheme.headlineMedium),
